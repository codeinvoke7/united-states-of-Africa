...
import { Volunteer1 } from 'assets/images';
      ...
      <div className="lg:px-[95px] absolute px-[20px]">
        <div className="text-[18px] mb-20">
          <ul className="flex justify-center ">
            ...
            <li className="text-[#39B755]">Volunteer</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-[18px]">
            With our volunteer programme, recent graduates and students are offered opportunities to
            get real life experience to boost or start their professional careers.
          </p>
        </div>
      </div>
    </div>
