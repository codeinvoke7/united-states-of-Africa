...
import { aboutHeaderBackground, aboutHeaderBackgroundMobile, teamMember1 } from 'assets/images';
    ...
    <>
      ...
      <section>
        <div className="bg-[#E4FFEE] grid place-content-center  shadow-xl">
          <div className=" font-serif font-bold text-center px-4 py-24 max-w-xl mx-auto">
            <p className=" text-[42px] text-center  mt-2 text-lime-500 text-gray-100 text-[#39B755]">
              To be able to make the impact that we are committed to make, <br></br> it takes an
              impactful group of passionate people.
            </p>

            <div className="flex gap-5 justify-center my-4">
              <button className="text-[#39B755] text-2xl border-2 border-solid px-5 py-2 border-[#39B755]  rounded-full hover:bg-[#39B755] cursor-pointer hover:text-[#FFF]">
                Leadership Team
              </button>
              <button className="text-[#39B755] text-2xl border-2 border-solid px-5 py-2 border-[#39B755]  rounded-full hover:bg-[#39B755] cursor-pointer hover:text-[#FFF]">
                Ambassadors
      ...
      <section>
        <div className="container mx-auto lg:px-8 py-16">
          <div className=" ">
            <div className="mx-auto mt-3 max-w-2xl lg:text-center">
              <p className="mt-2 font-bold text-4xl text-[#39B755]  ">Leadership Team</p>
              <p className="mt-2 text-xl text-gray-400">
                To able to make that impact that we are committed to make, it takes an impactful
                group of passionate people.
              </p>
              <p className="mt-2 text-xl text-gray-400">Know them here.</p>
            </div>
            <div className="grid place-content-center lg-mx-8 grid-cols-1 gap-y-10  py-20 lg:grid-cols-3 gap-x-16 lg:gap-y-16">
              <div className=" rounded  w-10/12">
                <div>
                  <img
                ...
                <div className="text-center text-2xl font-serif text-white font-semibold  pt-4">
                  Emilia Jones
                </div>
                <div className="mt-2 text-center text-gray-400">Vice President, USAF</div>
              ...
              <div className=" rounded  w-10/12 overflow-hidden">
                <div>
                  <img
          ...
          <div className=" ">
            <div className="mx-auto mt-3 max-w-2xl lg:text-center">
              <p className="mt-2 font-bold text-4xl text-[#39B755]  ">Ambassadors</p>
              <p className="mt-2 text-xl text-gray-400">
                To able to make that impact that we are committed to make, it takes an impactful
                group of passionate people.
              </p>
          ...
          <div className=" ">
            <div className="mx-auto mt-3 max-w-2xl lg:text-center">
              <p className="mt-2 font-bold text-4xl text-[#39B755]  ">Board Members</p>
              <p className="mt-2 text-xl text-gray-400">
                To able to make that impact that we are committed to make, it takes an impactful
                group of passionate people.
              </p>
